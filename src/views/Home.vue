      ...
      <section class="content-section">
        <div class="section-container">
          <div class="section-header">
            ...
            <p class="section-desc">Browse jobs by category and find the perfect match for your skills</p>
          </div>
      ...
      <section class="cta-section">
        <div class="section-container">
          <div class="cta-glass">
            ...
            <p class="cta-desc">Browse hundreds of opportunities from top employers in Singapore</p>
            <router-link to="/browse-jobs" class="btn-cta">
              Browse All Jobs
